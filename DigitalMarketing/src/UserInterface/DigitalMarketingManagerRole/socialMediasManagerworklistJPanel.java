 ...
 * @author dhava
 */
public class socialMediasManagerworklistJPanel extends javax.swing.JPanel {

    /**
     * Creates new form socialMediasManagerworklistJPanel
     */
      JPanel userProcessContainer;
   UserAccount account;
   Enterprise enterprise;
    public socialMediasManagerworklistJPanel(JPanel userProcessContainer,UserAccount account ,Enterprise enterprise) {
        initComponents();
 ...
 public void populateEmployeeComboBox(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, 780, 219));
        ...
        jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 220, 150, -1));

        ddlassignto.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(ddlassignto, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 240, 30));
